...
- CircuitSlide Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called CircuitSlide Lite. It should be a full-viewport sliding-circuit puzzle game where the player shifts neon tiles to connect power from a source node to an exit node before the timer ends. Include playable gameplay, pause overlay, settings screen with difficulty/speed/audio c…
...
- Gameplay - CircuitSlide Lite
- Game Settings - CircuitSlide Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - CircuitSlide Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - CircuitSlide Lite
